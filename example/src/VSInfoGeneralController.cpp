...
static void copy_string_to_arr(uint8_t str[], uint8_t arr[], int size) {
...
VSInfoGeneralController::VSInfoGeneralController( QObject* parent )
    : QObject( parent ),
      m_VSInfoGeneralList(),
      m_CurrentVSInfoGeneralModel( nullptr ) {
...
QQmlListProperty<VSInfoGeneralModel> VSInfoGeneralController::getVSInfoGeneralList() {
    return QQmlListProperty<VSInfoGeneralModel>( this, m_VSInfoGeneralList );
}

VSInfoGeneralModel* VSInfoGeneralController::getCurrentVSInfoGeneral() {
