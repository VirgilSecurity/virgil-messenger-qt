...
class VSInfoGeneralModel : public QObject {
    ...
    Q_PROPERTY(QString deviceType READ deviceType NOTIFY device_type_changed)
...
public:
    ...
    QString
    manufacture_id() const;
    QString
    deviceType() const;
    QString
    default_netif_mac() const;
    int
    device_roles() const;
...
signals:
    void
    manufacture_id_changed();
    void
    device_type_changed();
    void
    default_netif_mac_changed();
    void
    device_roles_changed();
    void
    fw_ver_changed();
    void
    tl_ver_changed();
